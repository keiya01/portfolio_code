        ...
        <div
            ...
            <div
                ...
                >
                    ...
                    自分のためというよりも他者のために書くという感覚であるため、曖昧な部分や間違っている部分がないかを
                    確認しながら書きます。そうすることで自分の理解がより深いものになったり、新たな発見があったりするので
                    Qiitaはより多くのアウトプットのためのツールとしても積極的に活用しています。
                </BlogItem>
            </div>
            <div
                ref={setContainer(3)}
                ...
                <BlogItem
                    ...
                    具体的には、記事を読んでいて参考になったコーディングの手法や、デザインパターンなどに対する自分なりの解釈、
                    自分がコードを書いていて難しいと感じたことをメモとして残しています。
                </BlogItem>
            </div>
            <div
                ref={setContainer(4)}
